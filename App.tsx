              ...
              <div className="p-5 bg-stripes relative">
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full py-3 font-display font-bold tracking-widest uppercase transition-all clip-corner relative overflow-hidden group ${
                      loading || !prompt.trim()
                  ...
                  {history.map((item) => (
                    ...
                    >
                      <div className="w-12 h-12 flex-shrink-0 bg-black border border-gray-700 overflow-hidden">
                        <img src={`data:image/png;base64,${item.base64}`} alt="thumb" className="w-full h-full object-cover" />
                      </div>
            ...
            <div className="mt-4 lg:hidden">
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {history.map((item) => (
                  ...
                  >
                    <img src={`data:image/png;base64,${item.base64}`} alt="history" className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
            </div>
